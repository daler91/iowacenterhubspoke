...
def _relocate_payload():
    return ScheduleRelocate(date="2026-06-01", start_time="13:00", end_time="14:00", force=False)


def _patch_relocate_side_effects(monkeypatch):
