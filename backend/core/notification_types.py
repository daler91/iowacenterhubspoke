...
NOTIFICATION_TYPES: dict[str, NotificationType] = {
    ...
    "task.comment_mentioned": {
        "key": "task.comment_mentioned",
        "category": "tasks",
        "label": "You were @-mentioned in a task comment",
        "description": "Someone tagged you with @ in a task comment.",
        "default_channels": {"in_app": "instant", "email": "instant"},
        "allowed_channels": {"in_app", "email"},
        "audience": {"internal", "partner"},
        "required_roles": None,
    ...
    "project.message_mentioned": {
        "key": "project.message_mentioned",
        "category": "projects",
        "label": "You were @-mentioned in a project message",
        "description": "Someone tagged you with @ in a project message.",
        "default_channels": {"in_app": "instant", "email": "instant"},
        "allowed_channels": {"in_app", "email"},
        "audience": {"internal", "partner"},
        "required_roles": None,
