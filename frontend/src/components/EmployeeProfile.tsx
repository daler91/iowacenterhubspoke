            ...
            <div className="flex items-center gap-5">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-4 mt-1 flex-wrap">
                  {employee.email && (
                    <div className="flex items-center gap-1 text-sm text-foreground/80 dark:text-muted-foreground">
                  ...
                  {(data.recent_schedules || []).map(s => (
                    <div key={s.id} className="flex items-center gap-3 p-3 bg-muted/50 dark:bg-muted/50 rounded-lg" data-testid={`recent-schedule-${s.id}`}>
                      ...
                      <div className="flex-1 min-w-0">
                        <EntityLink type="location" id={s.location_id} className="text-sm font-medium text-foreground">{s.location_name}</EntityLink>
