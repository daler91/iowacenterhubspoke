  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <Select value={filterEmployee} onValueChange={setFilterEmployee}>
        <SelectTrigger className="w-[180px] h-9 text-xs bg-white dark:bg-card" data-testid="filter-employee" aria-label="Filter by employee">
      ...
      <Select value={filterLocation} onValueChange={setFilterLocation}>
        <SelectTrigger className="w-[180px] h-9 text-xs bg-white dark:bg-card" data-testid="filter-location" aria-label="Filter by location">
      ...
      {classes && (
        <Select value={filterClass} onValueChange={setFilterClass}>
          <SelectTrigger className="w-[180px] h-9 text-xs bg-white dark:bg-card" data-testid="filter-class" aria-label="Filter by class">
