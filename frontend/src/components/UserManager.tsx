          ...
          {pendingUsers.length > 0 && (
            <div className="space-y-3">
              ...
              <div className="bg-warn-soft border border-warn-soft rounded-lg p-4 space-y-3">
                <VirtualizedWrapper items={pendingUsers} itemHeight={88} height={Math.min(320, Math.max(96, pendingUsers.length * 88))} role="list" ariaLabel="Pending approvals" renderItem={(u) => (
