    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          ...
          aria-label={`Notifications${activeNotifications.length > 0 ? ` (${activeNotifications.length})` : ''}`}
      ...
      <PopoverContent align="end" className="w-[380px] p-0" data-testid="notifications-dropdown">
