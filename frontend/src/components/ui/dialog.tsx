...
const DialogContent = React.forwardRef(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // `w-[calc(100%-2rem)]` reserves 1rem of margin on each side so
        // dialogs don't crash into the viewport edges on small phones.
        // Callers still override `max-w-*` for their desktop size; this
        // just caps the mobile render instead of going full-bleed.
