        ...
        {driveMin > 0 && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div
                  ...
                  style={{
                    ...
                    height: `${Math.max(driveBeforeHeight, 20)}px`,
                  }}
                >
              ...
              <TooltipContent>
                <p>
                  Drive from Hub to {schedule.location_name}: {driveMin} min
                </p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          ...
          <Tooltip>
                ...
                <div className="flex flex-col h-full justify-between">
                  <div>
                    <p
                      ...
                      data-testid={`calendar-class-name-${schedule.id}`}
                    >
                      {className}
                    </p>
            ...
            <TooltipContent side="right" className="max-w-xs">
              <div className="space-y-1">
                ...
                <p className="text-xs">
                  Drive: {schedule.drive_time_minutes}m each way
                </p>
        ...
        {driveMin > 0 && (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div
                  ...
                  style={{
                    ...
                    height: `${Math.max(driveAfterHeight, 20)}px`,
                  }}
                >
                  <div className="flex items-center gap-1">
                    <Car className="w-3 h-3" />
              ...
              <TooltipContent>
                <p>
                  Return drive from {schedule.location_name} to Hub: {driveMin}{" "}
                  min
                </p>
              </TooltipContent>
            </Tooltip>
        ...
        <div className="grid grid-cols-8 relative">
          ...
          <div className="border-r border-gray-100">
            {HOURS.map((hour) => (
              <div
                key={hour}
                className="h-[60px] px-2 flex items-start justify-end pt-1"
              >
