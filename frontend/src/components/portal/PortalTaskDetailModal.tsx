  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="left-auto top-1/2 right-4 translate-x-0 -translate-y-1/2 max-w-5xl w-[min(95vw,72rem)] max-h-[85vh] p-0 overflow-hidden gap-0 rounded-2xl">
