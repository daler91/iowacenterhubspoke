...
export default function ActivityFeed(props: Readonly<ActivityFeedProps>) {
    ...
    return (
      <div className="space-y-6 animate-slide-in" data-testid="activity-feed">
        <div>
          ...
          <p className="text-sm text-foreground/80 dark:text-muted-foreground mt-1">Recent actions and updates</p>
        </div>
        <div className="bg-white dark:bg-card rounded-lg border border-border p-12 text-center">
          <Activity className="w-12 h-12 mx-auto text-muted-foreground dark:text-foreground mb-3" />
  ...
  return (
    <div className="space-y-6 animate-slide-in" data-testid="activity-feed">
      <div>
        <h2 className="text-2xl font-bold text-foreground">Activity Feed</h2>
        <p className="text-sm text-foreground/80 dark:text-muted-foreground mt-1">Recent actions and updates across the team</p>
      </div>
